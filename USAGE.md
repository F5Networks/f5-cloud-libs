...
Does initial configuration and provisioning of a BIG-IP.
    ...
    Options:
      ...
      --cloud <provider>                                                                                                                                                                                                                       Cloud provider (aws | azure | etc.). This is required if licensing via BIG-IQ 5.4+ is being used, signalling resource provisioned, or providing a master key via --master-key-uri
         ...
         --master-key-uri <key_uri>                                                                                                                                                                                                               URI (arn) to location that contains BIG-IQ master key.
