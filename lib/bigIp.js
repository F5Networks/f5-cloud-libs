    ...
    return this.ready()
        ...
        .then(function(folders) {
            ...
            var folderExists = function(element) {
                return element.fullPath === options.subPath + '/' + fullPath;
            };
...
BigIp.prototype.getCloudPrivateKeyFilePath = function() {
    ...
    return this.ready()
        ...
        .then(function(response) {
            const KEY_FILE_PREFIX = ':Common:' + CLOUD_LIBS_PRIVATE_KEY + '.key';
 ...
 *                    or rejected if an error occurs.
 */
BigIp.prototype.installCloudPrivateKey = function(privateKeyFile) {
