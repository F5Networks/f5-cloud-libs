 ...
 * @param {Object} [logger]   - A logger to use. Default to no logging.
 * @param {Object} [testOpts] - Options used during testing.
 */
function BigIp(host, user, password, logger, testOpts) {

    this.logger = logger || Logger.getLogger({logLevel: 'none'});
    ...
    this.cluster = new BigIpCluster(this, logger, testOpts);
    this.onboard = new BigIpOnboard(this, logger, testOpts);
}
