...
BigIq.prototype.revokeLicense = function revokeLicense(poolName, instance) {
    ...
    try {
        ...
        return licenseProvider.revoke(icontrol, poolName, instance);
    } catch (err) {
...
function getLicenseProvider(version) {
    ...
    if (util.versionCompare(version, '5.0.0') >= 0 && util.versionCompare(version, '5.2.0') < 0) {
        return new BigIq50LicenseProvider(this.bigIp, this.constructorOptions);
    } else if (util.versionCompare(version, '5.2.0') >= 0 && util.versionCompare(version, '5.3.0') < 0) {
        return new BigIq52LicenseProvider(this.bigIp, this.constructorOptions);
    }
    return new BigIq53LicenseProvider(this.bigIp, this.constructorOptions);
}
