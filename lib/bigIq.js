...
BigIq.prototype.licenseBigIp = function licenseBigIp(poolName, bigIpMgmtAddress, bigIpMgmtPort, options) {
    ...
    return getLicenseProvider.call(this, poolName, options)
...
function getLicenseProvider(poolName, options) {
    ...
    if (options.autoApiType) {
        return getApiType.call(this, poolName, options)
            .then((apiType) => {
                ...
                return q(bigIqLicenseProviderFactory.getLicenseProviderByType(
                    apiType,
                    this.bigIp,
                    factoryOptions
                ));
    ...
    return q(bigIqLicenseProviderFactory.getLicenseProviderByVersion(
        this.version,
        this.bigIp,
        factoryOptions
    ));
