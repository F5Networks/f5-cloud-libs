...
BigIq.prototype.init = function(host, user, passwordOrUri, options) {
    ...
    return getActualPassword.call(this, passwordOrUri, this.constructorOptions)
        ...
        .then(function(response) {
            ...
            return this.bigIqControl.list('/shared/resolver/device-groups/cm-shared-all-big-iqs/devices?$select=version');
    }.bind(this))
    .then(function(response) {
...
BigIq.prototype.revoke = function(poolName, bigIpMgmtAddress, bigIpMgmtPort) {
    var licenseProvider = getLicenseProvider(this.version);
    return licenseProvider.revoke(icontrol, poolName, bigIpMgmtAddress, bigIpMgmtPort);
};

var getActualPassword = function(passwordOrUri, options) {
...
var getLicenseProvider = function(version) {
    ...
    if (util.versionCompare(version, '5.0.0') >= 0 && util.versionCompare(version, '5.2.0') < 0) {
        return new BigIq5_0LicenseProvider(this.core, this.options);
    }
    else if (util.versionCompare(version, '5.2.0') >= 0 && util.versionCompare(version, '5.3.0') < 0) {
        return new BigIq5_2LicenseProvider(this.core, this.options);
    }
    else if (util.versionCompare(version, '5.3.0') >= 0) {
        return new BigIq5_3LicenseProvider(this.core, this.options);
    }
    else {
