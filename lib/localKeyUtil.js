...
module.exports = {
    ...
    generateAndInstallKeyPair(
        ...
        assert.strictEqual(typeof publicKeyDirectory, 'string', 'publicKeyDirectory must be a string');
        assert.strictEqual(typeof publicKeyOutFile, 'string', 'publicKeyOutFile must be a string');
        assert.strictEqual(typeof privateKeyFolder, 'string', 'privateKeyFolder must be a string');
        assert.strictEqual(typeof privateKeyName, 'string', 'privateKeyName must be a string');
