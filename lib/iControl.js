...
var IControl = function(options) {
    ...
    this.user     = (typeof options.user     === 'string')  ? options.user     : 'admin';
    this.password = (typeof options.password === 'string')  ? options.password : 'admin';
    this.basePath = (typeof options.basePath === 'string')  ? options.basePath : '/mgmt';
    this.strict   = (typeof options.strict   === 'boolean') ? options.strict   : true;
 ...
 *                    has 'items' in it, only the items are returned.
 */
IControl.prototype.delete = function(path, options) {
...
IControl.prototype.request = function(method, path, body, options) {
    ...
    httpRequest = this.https.request(requestOptions, function(response) {
        var totalResponse = '';
        ...
        response.on('end', function() {
            ...
            if (headers['content-type'] && headers['content-type'].indexOf('application/json') !== -1) {
                try {
                    ...
                    deferred.reject("Unable to parse JSON response.", err);
                    return;
                }
