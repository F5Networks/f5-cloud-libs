...
module.exports = {
    ...
    /**
     * Filters option arguments provided based on a list to keep
     *
     * @param {Object} options      - Options object to pull arguments from
     * @param {Object} [argsToKeep] - Arguments to keep. Default none.
     */
    getArgsToStrip(options, argsToKeep) {
        ...
        options.options.forEach((opt) => {
            if (argsTK) {
                ...
                if (opt.short && argsTK.indexOf(opt.short) === -1) {
