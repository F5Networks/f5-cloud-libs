...
module.exports = {
     ...
     *                    within maxTries.
     */
    tryUntil: function(maxTries, interval, funcToTry) {
        var _tryUntil = function(maxTries, interval, funcToTry, deferred, resolve, reject) {
            ...
            funcToTry()
                ...
                .catch(function() {
                    if (maxTries > 0) {
                        setTimeout(_tryUntil, interval, maxTries, interval, funcToTry, deferred, resolve, reject);
                    }
                    else {
     ...
     *                              }
     */
    callInSerial: function(thisArg, promises) {
