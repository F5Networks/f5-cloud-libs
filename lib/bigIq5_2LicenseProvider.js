 ...
 */
BigIq5_2LicenseProvider.prototype.revoke = function(bigIqControl, poolName, bigIpMgmtAddress, bigIpMgmtPort) {
    return getPoolUuid(bigIqControl, poolName)
        .then(function(poolUuid) {
...
var getValidRegKey = function(bigIqControl, poolUuid) {
    ...
    return getRegKeysInPool(bigIqControl, poolUuid)
        .then(function(response) {
...
var getRegKeysInPool = function(bigIqControl, poolUuid) {
