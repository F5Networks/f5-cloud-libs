...
BigIq5_2LicenseProvider.prototype.getUnmanagedDeviceLicense = function(bigIqControl, poolName, bigIpMgmtAddress, bigIpMgmtPort) {
    ...
    return getPoolUuid(bigIqControl, poolName)
        .then(function(poolUuid) {
            ...
            return util.tryUntil(this, util.MEDIUM_RETRY, licenseFromPool, [bigIqControl, bigIpMgmtAddress, bigIpMgmtPort, poolUuid]);
        }.bind(this))
        .catch(function(err) {
 ...
 */
BigIq5_2LicenseProvider.prototype.getLicenseTimeout = function() {
