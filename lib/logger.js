...
module.exports = {
     ...
     * @param {Object}  [options.module]        - The module the logger is used from. Used to put the
     *                                            file name in the log message.
     * @param {Boolean} [options.json]          - Whether or not to format message as JSON. Default false.
     * @param {Boolean} [options.verboseLabel]  - Whether or not to include the verbose label in log.
     *                                            Default false.
     *
    ...
    getLogger(options) {
        ...
        const logJson = (options && typeof options.json !== 'undefined') ? options.json : false;
        const verboseLabel =
            (options && typeof options.verboseLabel !== 'undefined') ? options.verboseLabel : false;
        ...
        const transportOptions = {
            ...
            label: getLabel(logLevel, moduleLogging, verboseLabel),
...
// module's filename.
function getLabel(logLevel, moduleLogging, verboseLabel) {
    let parts;
    let label = '';
