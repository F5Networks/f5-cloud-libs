            ...
            return this.ready()
                ...
                .then(function(responses) {
                    if (responses.length !== promises.length) {
                        throw new Error("Not all responses received.");
                    }

                    if (!responses[1].configsyncIp || responses[1].configsyncIp === 'none') {
                        throw new Error("No config sync IP.");
                    }
                }.bind(this));
            };
            ...
            if (options.sync) {
                return this.core.deviceInfo()
                    .then(function(response) {
                        ...
                        return util.tryUntil(this, {maxRetries: 10, retryIntervalMs: 30000}, syncAndCheck, [dataSyncResponse]);
                    }.bind(this));
            }
        }.bind(this));
};
