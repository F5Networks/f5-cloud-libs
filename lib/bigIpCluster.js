 ...
 *                    or rejected if an error occurs.
 */
BigIpCluster.prototype.deleteDeviceGroup = function(deviceGroup, retryOptions) {
 ...
 *                    or rejected if an error occurs.
 */
BigIpCluster.prototype.removeAllFromDeviceGroup = function(deviceGroup, retryOptions) {
    retryOptions = retryOptions || util.DEFAULT_RETRY;
...
BigIpCluster.prototype.resetTrust = function(retryOptions) {
    ...
    return this.core.ready()
        ...
        .then(function(response) {
            ...
            var resetPath = '/tm/cm/trust-domain';
            if (util.versionCompare(version, '13.0.0') < 0) {
                resetPath += '/Root';
            }
            return this.core.delete(resetPath, undefined, util.NO_RETRY);
        }.bind(this))
        .then(function() {
