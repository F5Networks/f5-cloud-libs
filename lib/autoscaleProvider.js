 ...
 * @param {String} toUser       - The user that was used for this sync (so it can be deleted
 *                                if we are using a temporary user)
 *
 * @returns {Promise} A promise which will be resolved when the messages
 *                    have been received and processed
 */
/* jshint unused: false */
AutoscaleProvider.prototype.syncComplete = function(fromUser, fromPassword, toUser) {
