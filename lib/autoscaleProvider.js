 ...
 */
 AutoscaleProvider.prototype.getPublicKey = function(instanceId) {
     if (this.features[AutoscaleProvider.FEATURE_ENCRYPTION]) {
 ...
 */
AutoscaleProvider.prototype.sendMessage = function(actionId, options) {
    if (this.features[AutoscaleProvider.FEATURE_MESSAGING]) {
        throw new Error("Unimplemented abstract method AutoscaleProvider.sendMessage", actionId, options);
    }
    else {
