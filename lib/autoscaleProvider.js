...
AutoscaleProvider.FEATURE_SHARED_PASSWORD = 'FEATURE_SHARED_PASSWORD'; // password is the same for all members of a cluster
 ...
 * @returns {Promise} A promise which will be resolved when init is complete.
 */
AutoscaleProvider.prototype.bigIpReady = function() {
...
AutoscaleProvider.prototype.revokeLicenses = function(instances, options) {
    ...
    if (instances.length > 0) {
        ...
        var bigIq = this.bigIq || new BigIq(this.options);
