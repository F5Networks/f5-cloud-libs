 ...
 * @returns {Promise} A promise which will be resolved when processing is complete.
 */
AutoscaleProvider.prototype.tagMasterInstance = function tagMasterInstance(instanceId, instances) {
    this.logger.debug('No override for AutoscaleProvider.tagMasterInstance', instanceId, instances);
    return q();
};
