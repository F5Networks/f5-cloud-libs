 ...
 * @abstract
 *
 * @param {String} messageId - ID of message to send
 ...
 */
AutoscaleProvider.prototype.sendMessage = function(messageId, options) {
    if (this.features[AutoscaleProvider.FEATURE_MESSAGING]) {
        throw new Error("Unimplemented abstract method AutoscaleProvider.sendMessage", messageId, options);
    }
    else {
