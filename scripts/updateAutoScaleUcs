...
def main():
    ...
    if not original_ucs:
        print "Usage: "
        print ("    ./%s --original-ucs <ucs_filename>" % (sys.argv[0]))
        print ("    ./%s --original-ucs <ucs_filename> --updated-ucs <ucs_filename>" % (sys.argv[0]))
        print "ex. "
        print ("    ./%s --original-ucs original.ucs --updated-ucs updated.ucs" % (sys.argv[0]))
        sys.exit()
    ...
    # Replace IP, String Versions in other files
